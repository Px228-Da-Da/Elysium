            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        // "Лаб" — opens the audio-analysis window (top-right corner).
                        let lab_btn = ui.add(
                            egui::Button::new(
                                RichText::new(s.lab_button)
                                    .size(13.0)
                                    .color(Color32::from_rgb(255, 120, 135)),
                            )
                            .rounding(15.0)
                            .fill(Color32::from_rgb(34, 16, 20))
                            .stroke(egui::Stroke::new(1.0, Color32::from_rgb(150, 40, 55))),
                        );
                        if lab_btn.clicked() {
                            self.show_lab = true;
                        }
